...
// 성과물 섹션 출력 시작
?>
<div class="section-title fs-4 text-black-50 document text-start"><i class="fa fa-folder"></i> 성과물</div>
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 mb-4">
    ...
    ?>
    <div class="col">
        <div id="shadow-box" class="card">
            <a class="card-header text-center text-white bg-dark bg-gradient" href="<?php echo get_category_link($category->term_id); ?>"><?php echo esc_html($category->name); ?></a>
